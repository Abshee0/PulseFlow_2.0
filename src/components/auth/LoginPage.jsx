...
const schema = yup.object({
  email: yup
    ...
    .matches(/@pulseflow\.com$/, 'Email must be from @pulseflow.com domain')
    ...
    try {
      ...
      if (error) {
        if (error.message === 'Email not confirmed') {
          setError('Your email address has not been confirmed. Please check your inbox for a verification link.')
        } else {
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <img src={Logo} alt="PulseFlow" className="h-16 w-16" />
            </div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">
              Welcome back
            </h1>
            <p className="text-slate-600 dark:text-slate-400">
              Sign in to your PulseFlow account
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  {...register('email')}
                  type="email"
                  placeholder="your.name@pulseflow.com"
